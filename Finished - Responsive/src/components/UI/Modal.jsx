...
function Modal({ children, modalName }) {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 top-0 z-10 flex items-center justify-center bg-primary-800 px-4 transition-all duration-300 sm:px-16 md:px-24 ${displayModal ? "visible bg-opacity-70" : "invisible bg-opacity-0"}`}
